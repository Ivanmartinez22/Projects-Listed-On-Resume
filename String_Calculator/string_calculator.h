...
throws: none 
*/
std::string trim_negative_and_zeros(std::string input_num);
std::string trim_only_zeros(std::string input_num);
std::string trim_leading_zeros(std::string num);

unsigned int char_counter(std::string input_num);
std::string top_string(std::string a, std::string b);
std::string bottom_string(std::string a, std::string b);
std::string adding_zeros_to_bottom_string(std::string a, std::string b);
